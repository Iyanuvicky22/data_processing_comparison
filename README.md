...
```
data_processing_api/    ├── .gitignore    ├── README.md    ├── main.py    ├── pyproject.toml    ├── poetry.lock    ├── pictures/    │   ├── flowcharts    │   ├── api_endpoints results    ├── data/    │   ├── online_retail_ii.xlsx    │   ├── transformed_data.json    │   ├── transformed_data.parquet     ├── processor/    |   ├── utils/    |   |   ├── __init__.py    |   |   ├── logger.py    |   |   ├── utils.py    │   ├── __init__.py    │   ├── url_load.py    │   ├── load_data.py    │   ├── clean.py    │   ├── aggregate.py    └── tests/        ├── __init__.py        └── test_processor.py
```

### PROJECT MAP

![alt text](https://file%2B.vscode-resource.vscode-cdn.net/c%3A/Users/APIN%20PC/OneDrive/Documents/DS/DE_Inter/data-processing-api/pictures/data_processing_complete_flow.jpg)
...
```
From the terminal run `poetry run uvicorn app.main:app --reload`
```
...
```
GET/home "Welcome Message"GET/Visualization (IQR) "Data Spread Visualizations"GET/Data Processing "Data Processing"GET/Time Comparison "Time Comparison"GET/download-json "Download Json"GET/download-parquet "Download Parquet"
```

![alt text](https://file%2B.vscode-resource.vscode-cdn.net/c%3A/Users/APIN%20PC/OneDrive/Documents/DS/DE_Inter/data-processing-api/pictures/fastapi_endpoints.png)

## Example Results

\# ***Pandas Data Processing Aggregate Results***
![alt text](https://file%2B.vscode-resource.vscode-cdn.net/c%3A/Users/APIN%20PC/OneDrive/Documents/DS/DE_Inter/data-processing-api/pictures/pandas_insights.png)

\# ***Polars Data Processing Aggregate Results***
![alt text](https://file%2B.vscode-resource.vscode-cdn.net/c%3A/Users/APIN%20PC/OneDrive/Documents/DS/DE_Inter/data-processing-api/pictures/polars_insights.png)

Time Comparison  
![alt text](https://file%2B.vscode-resource.vscode-cdn.net/c%3A/Users/APIN%20PC/OneDrive/Documents/DS/DE_Inter/data-processing-api/pictures/time_comparison_results.png)
